export default function CommunityComponent() {
    return (
        <div className="flex h-screen w-full flex-col items-center justify-center space-y-8 text-center">
            ...
            <p className="w-1/3 text-xl text-grey-lighter">
                "Building houses is not just about bricks and mortar, it's about
                creating a space where our community can flourish and find true
                happiness"
            </p>
        </div>
    );
